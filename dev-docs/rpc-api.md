...
**Failure response:**
```json
{"jsonrpc": "2.0", "error": {"code": -32008, "message": "Invalid authentication token"}, "id": 1}
```
...
{
    "tracks": [
        {"id": 1, "name": "Video 1", "type": "video", "locked": false, "muted": false, "hidden": false},
        {"id": 2, "name": "Audio 1", "type": "audio", "locked": false, "muted": false, "hidden": false}
    ]
}
```
...
{
    "markers": [
        {"position": 100, "comment": "Good take", "type": 0}
    ]
}
```
...
```json
{
    "jobs": [
        ...
        {"jobId": "def456", "status": "completed", "output": "/path/to/output.mp4"}
    ]
}
```
